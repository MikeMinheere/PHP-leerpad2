...
<html>
    ...
    <body>
        ...
        <div id= "mainDiv" class="container" <?php echo $styleForm;?>>
            <form action="Onkunde.php" method="post" id="formInput">
        ...
        <div id="result" class="container" <?php echo $styleResult;?>>
            <p>Mijn geheime talent is <?php echo $input1?>. ik ben hier erg slecht in, maar altijd beter dan <?php echo $input2?>. ik gebruik hier altijd een <?php echo $input3?> voor om mijn talent uit te voeren.
            <?php echo $input4?> is denk ik wel een eigenschap die ik niet nodig heb. <?php echo $input5?> is iets wat ik meer moet doen. <?php echo $input6?> Bababoui.
            </p>    
        </div>
    </body>
    <footer>
